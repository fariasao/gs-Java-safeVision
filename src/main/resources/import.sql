...
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Laura Silva', 123456789, '2012-02-01', 'Feminino'); --(Filha de Joana Silva)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Pedro Oliveira', 987654321, '2009-12-15', 'Masculino'); --(Filho de Carlos Oliveira)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Sofia Santos', 555555555, '2015-10-20', 'Feminino'); --(Filha de Maria Santos)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Gabriel Souza', 111111114, '2013-05-05', 'Masculino'); --(Filho de Rafael Souza)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Ana Julia Almeida', 999999905, '2012-12-12', 'Feminino'); --(Filha de Isabela Almeida)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Matheus Lima', 777777777, '2017-08-03', 'Masculino'); --(Filho de Felipe Lima)
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Amanda Pereira', 888888807, '1998-04-15', 'Feminino');
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Lucas Mendes', 444444444, '1989-11-11', 'Masculino');
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Juliana Rocha', 666666669, '1997-07-07', 'Feminino');
INSERT INTO tb_sv_dependente (nome_dependente, rg_dependente, data_nascimento, sexo_dependente) VALUES ('Caio Costa', 332233225, '1944-06-30', 'Masculino'); -- (pai de Thiago Costa)

-- INSERTS tb_sv_paciente
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (1, 'Joana Silva', 'joana.silva@gmail.com', 'senha1', 12345678901, '1981-07-24');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (2, 'Carlos Oliveira', 'carlos.oliveira@gmail.com', 'senha2', 98765432102, '1978-10-20');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (3, 'Maria Santos', 'maria.santos@gmail.com', 'senha3', 55555555503, '1985-04-02');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (4, 'Rafael Souza', 'rafael.souza@gmail.com', 'senha4', 11111111104, '1980-01-05');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (5, 'Isabela Almeida', 'isabela.almeida@gmail.com', 'senha5', 99999999905, '1982-09-08');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (6, 'Felipe Lima', 'felipe.lima@gmail.com', 'senha6', 77777777706, '1977-09-12');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (7, 'Amanda Pereira', 'amanda.pereira@gmail.com', 'senha7', 88888888807, '1998-04-15');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (8, 'Lucas Mendes', 'lucas.mendes@gmail.com', 'senha8', 44444444408, '1989-11-11');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (9, 'Juliana Rocha', 'juliana.rocha@gmail.com', 'senha9', 66666666609, '1997-07-07');
INSERT INTO tb_sv_paciente (id_dependente, nome_paciente, email_paciente, senha_paciente, telefone_paciente, data_nascimento) VALUES (10, 'Thiago Costa', 'thiago.costa@gmail.com', 'senha10', 22222222210, '1986-08-15');
...
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (1, '2023-01-01', '/imagens/pacientes/paciente1/imagem1', 'Paciente com retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (2, '2023-02-02', '/imagens/pacientes/paciente2/imagem2', 'Paciente com retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (3, '2023-03-03', '/imagens/pacientes/paciente3/imagem3', 'Paciente com suspeita de retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (4, '2023-04-04', '/imagens/pacientes/paciente4/imagem4', 'Paciente com baixas suspeitas de retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (5, '2023-05-05', '/imagens/pacientes/paciente5/imagem5', 'Paciente com suspeita de retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (6, '2023-06-06', '/imagens/pacientes/paciente6/imagem6', 'Paciente com retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (7, '2023-07-07', '/imagens/pacientes/paciente7/imagem7', 'Paciente com suspeita de retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (8, '2023-08-08', '/imagens/pacientes/paciente8/imagem8', 'Paciente sem retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (9, '2023-09-09', '/imagens/pacientes/paciente9/imagem9', 'Paciente sem retinoblastoma.');
INSERT INTO tb_sv_imagens (id_paciente, data_arquivo, caminho_arquivos, observacoes) VALUES (10, '2023-09-09', '/imagens/pacientes/paciente10/imagem10', 'Paciente com retinoblastoma.');

-- INSERTS tb_sv_resultados
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (1, '2022-01-15', 'Retinoblastoma', 95.5, 'De acordo com a an�lise das imagens, o paciente tem alta probabilidade de ter retinoblastoma. Um acompanhamento com especialistas da �rea � recomendado.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (2, '2022-02-20', 'Retinoblastoma', 88.2, 'De acordo com a an�lise das imagens, o paciente tem alta probabilidade de ter retinoblastoma. Um acompanhamento com especialistas da �rea � recomendado.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (3, '2022-03-25', 'Poss�vel Retinoblastoma', 75.0, 'De acordo com a an�lise das imagens, o paciente pode ser acometido com retinoblastoma. � recomendado n�o somente um acompanhamento com especialistas, mas tamb�m exames para acertividade no diagn�stico.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (4, '2022-04-10', 'Improv�vel Retinoblastoma', 30.8, 'De acordo com a an�lise das imagens, o paciente tem baixa probabilidade de ter retinoblastoma. Ainda assim, � recomendado a consulta com um especialista e um teste feito pelo profissional para retirar as d�vidas.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (5, '2022-05-12', 'Poss�vel Retinoblastoma', 82.3, 'De acordo com a an�lise das imagens, o paciente pode ser acometido com retinoblastoma. � recomendado n�o somente um acompanhamento com especialistas, mas tamb�m exames para acertividade no diagn�stico.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (6, '2022-06-18', 'Retinoblastoma', 93.7, 'De acordo com a an�lise das imagens, o paciente tem alta probabilidade de ter retinoblastoma. Um acompanhamento com especialistas da �rea � recomendado.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (7, '2022-07-21', 'Poss�vel Retinoblastoma', 55.9, 'De acordo com a an�lise das imagens, o paciente pode ser acometido com retinoblastoma. � recomendado n�o somente um acompanhamento com especialistas, mas tamb�m exames para acertividade no diagn�stico.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (8, '2022-08-30', 'N�o acometido por Retinoblastoma', 14.2, 'De acordo com a an�lise das imagens, o paciente n�o � acometido por retinoblastoma. A princ�pio, n�o � necess�rio acompanhamento m�dico, apenas a recomenda��o de aten��o para o mesmo.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (9, '2022-09-05', 'N�o acometido por Retinoblastoma', 10.1, 'De acordo com a an�lise das imagens, o paciente n�o � acometido por retinoblastoma. A princ�pio, n�o � necess�rio acompanhamento m�dico, apenas a recomenda��o de aten��o para o mesmo.');
INSERT INTO tb_sv_resultados (id_imagem, data_analise, diagnostico, probabilidade, comentarios) VALUES (10, '2022-10-10', 'Retinoblastoma', 88.9, 'De acordo com a an�lise das imagens, o paciente tem alta probabilidade de ter retinoblastoma. Um acompanhamento com especialistas da �rea � recomendado.');
